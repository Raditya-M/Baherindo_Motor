...
@section('title', $mobil->nama_mobil . ' - Baherindo Motors')
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="mb-8">
            <div class="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <a href="/" class="hover:text-blue-600 transition-colors">Mobils</a>
                <i class="fas fa-chevron-right text-xs"></i>
                <span class="text-gray-900 font-medium">{{ $mobil->nama_mobil }}</span>
            </div>
        </nav>
        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
            <div class="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div class="p-8 lg:p-12 flex flex-col justify-between">
                    <div>
                        ...
                        <div class="mb-8">
                            <span class="text-4xl font-bold text-blue-600">
                                Rp {{ number_format($mobil->harga_mobil) }}
                            </span>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-6 mb-8">
                            <div class="bg-gray-50 rounded-2xl p-4">
                                ...
                                <span class="text-xl font-bold text-gray-900">{{ $mobil->tahun_mobil }}</span>
                            </div>
                            ...
                            <div class="bg-gray-50 rounded-2xl p-4">
                                ...
                                <span class="text-xl font-bold text-gray-900">{{ number_format($mobil->km_mobil) }} km</span>
                            </div>
                        </div>
                    ...
                    <div class="space-y-4">
                        <!-- WhatsApp Button -->
                        <a href="https://wa.me/081385260075?text=Halo,%20saya%20tertarik%20dengan%20{{ urlencode($mobil->nama_mobil) }}" 
            ...
            <div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-6 text-white">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between">
                        <span>DP Mulai:</span>
                        <span class="font-semibold">Rp {{ number_format($mobil->harga_mobil * 0.2) }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Cicilan 12 Bulan:</span>
                        <span class="font-semibold">Rp {{ number_format(($mobil->harga_mobil * 0.8) / 12) }}/bulan</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Cicilan 24 Bulan:</span>
                        <span class="font-semibold">Rp {{ number_format(($mobil->harga_mobil * 0.8) / 24) }}/bulan</span>
                    </div>
                </div>
